  ...
  return (
    ...
    >
      ...
      <p className="text-center text-lg mb-8">
        Secure the installation process by installing the TransferX certificate.
        This simple process ensures trust and eliminates any installation
        warnings.
      </p>
      ...
      <section className="bg-[--primary-color] p-8 rounded-lg shadow-md mb-12">
        ...
        <p className="mb-4">
          ...
          installing our trusted certificate, you can ensure a smooth and secure
